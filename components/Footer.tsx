...
const Footer: React.FC<FooterProps> = ({ lastUpdated, totalItems, loadedItems }) => {
    ...
    return (
        <div className="absolute bottom-0 left-0 w-full bg-slate-900/90 backdrop-blur border-t border-slate-800 text-slate-400 text-xs font-mono p-2 px-6 flex flex-col md:flex-row justify-between items-center z-30 gap-2 md:gap-0">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="text-[10px] opacity-50 hidden md:block border-l border-slate-700 pl-4 text-slate-500">
